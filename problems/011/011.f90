PROGRAM F011
    ...
    INTEGER :: I, J, TEMP_PRODUCT, MAX_PRODUCT
    LOGICAL, DIMENSION(3) :: IS_RC_SAFE
    ...
    DO WHILE (I <= 20)
        ...
        DO WHILE (J <= 20)
            ...
            IF ((I + 3) <= 20) THEN
               ...
               .OR.    (GRID(I+2, J) > 50) .OR.  (GRID(I+3, J) > 50)) ) THEN
            ...
            IF ((J + 3) <= 20) THEN
               ...
               .OR.    (GRID(I, J+2) > 50) .OR.  (GRID(I, J+3) > 50)) ) THEN
